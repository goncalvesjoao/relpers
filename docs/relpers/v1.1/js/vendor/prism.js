/* http://prismjs.com/download.html?themes=prism-coy&languages=markup+css+clike+javascript+applescript+bash+batch+c+csharp+cpp+coffeescript+ruby+css-extras+diff+docker+elixir+erlang+gherkin+git+go+haml+handlebars+http+markdown+nginx+objectivec+php+jsx+sas+sass+scss+sql+swift+typescript+vim+yaml&plugins=line-highlight+line-numbers */
...
Prism.hooks.add('complete', function (env) {
	...
	if (pre.hasAttribute('data-bash-mode')) {
	  lineNumbersWrapper.className += ' bash';
	}
